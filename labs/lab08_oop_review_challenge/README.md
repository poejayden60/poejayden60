...
This lab is an integrated OOP challenge.

You will design a small inventory system for a bookstore. This lab combines the ideas from Labs 5–7:
...
```bash
git checkout -b lab08-oop-challenge
```
